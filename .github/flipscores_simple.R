...
#' # @param output_flips \code{FALSE} by default. If \code{TRUE} the \code{flips} matrix is returned. Useful when the same flips are needed for more glms, for example in the case of multivariate glms where the joint distribution of test statistis if used for multivariate inference.@param ... see \code{glm} function.
#'
#'
...
.flipscores_engine<-function(formula, family, data,
