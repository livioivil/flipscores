...
helper defines factor contrasts with a syntax similar to `emmeans`, or
accepts a custom coefficient contrast matrix in the spirit of
`multcomp::glht()`, then applies the flip-score test.
