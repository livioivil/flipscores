...
#> (Intercept)  0.02207  0.26383    3.44133  0.07666     0.016   0.9380    
#> ZB           0.02318  0.13383    2.39994  0.05576     0.012   0.9564    
#> ZC           0.15946  1.36568    2.93906  0.46467     0.097   0.6498    
...
#> Model 2: Y ~ Z + X
#>                    Df    Score Pr(>Score)    
#> Model 2 vs Model 1  1 0.042235      8e-04 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
# and
...
#> Model 2: Y ~ Z + X
#>                    Df   Score Pr(>Score)
#> Model 2 vs Model 1  2 0.27888     0.8888
```
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)    
#> (Intercept)  0.02207  0.26383    3.44133  0.07666     0.016   0.9360    
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)    
#> (Intercept)  0.02207  0.26383    3.44133  0.07666     0.016    0.940    
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)
#> (Intercept)  0.02207  0.26383    3.44133  0.07666     0.016    0.543
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)    
#> (Intercept)  0.02207  0.26383    3.44133  0.07666     0.016   0.4748    
#> ZB           0.02318  0.13383    2.39994  0.05576     0.012   0.4734    
#> ZC           0.15946  1.36568    2.93906  0.46467     0.097   0.3320    
#> X            0.89732 35.59669    6.63014  5.36892     0.726   0.0002 ***
#> ---
#> Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
#> 
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)    
#> (Intercept)  0.02208  0.26385    3.18354  0.08288     0.016   0.9316    
#> ZB           0.02316  0.13368    2.20995  0.06049     0.012   0.9594    
#> ZC           0.15946  1.36541    2.72310  0.50142     0.096   0.6426    
...
#>                  2.5 %    97.5 %
#> (Intercept) -0.8713311 0.4645158
#> ZB          -1.5639321 0.9194265
#> ZC          -0.6405148 0.9056378
#> X            0.6406719 1.2973049
```
