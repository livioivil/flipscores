...
#> ZB          -0.18558 -0.50868    1.65785 -0.30683    -0.108    0.677   
#> ZC           1.40981  8.55380    2.58950  3.30326     0.765    0.003 **
#> X           -0.06964 -1.56935    4.70999 -0.33320    -0.117    0.664   
#> ---
...
#> Coefficients:
#>             Estimate    Score Std. Error  z value Part. Cor Pr(>|z|)  
#> (Intercept)  -0.1486  -0.2102     1.1881  -0.1770    -0.067    0.898  
#> ZB          -20.4539  -1.4784     0.7466  -1.9802    -0.530    0.046 *
...
gcor(mod, terms = c("X", "ZC"),normalize=TRUE)
#>    terms          r        r_n null_model   algorithm is.exact
#> X     ~X -0.1493213 -0.1871822   ~1+ZB+ZC multi_start    FALSE
#> ZC   ~ZC  0.6146304  0.6148542    ~1+ZB+X multi_start    FALSE
