...
#> ZB          -0.18558 -0.50868    1.65785 -0.30683    -0.108    0.658   
...
#> ZB          -20.4539  -1.4784     0.7466  -1.9802    -0.530    0.063 .
#> ZC           20.8561   1.8043     0.8180   2.2057     0.615    0.021 *
#> X            -0.4276  -0.3782     0.9574  -0.3951    -0.149    0.740  
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
...
gcor(mod, terms = c("X", "ZC"),normalize=TRUE)
#>    terms          r        r_n null_model   algorithm is.exact
#> X     ~X -0.1493213 -0.1700284   ~1+ZB+ZC multi_start    FALSE
#> ZC   ~ZC  0.6146304  0.6148542    ~1+ZB+X multi_start    FALSE
