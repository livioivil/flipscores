...
#> (Intercept)  -0.3513 -5.4234     4.2404 -1.2790    -0.169   0.1176   
#> ZB            0.2276  1.8048     2.8140  0.6414     0.079   0.4628   
#> ZC            0.9034 10.3392     3.4527  2.9945     0.348   0.0210 * 
...
#> ZB            0.3570  2.3488     2.6093  0.9002     0.145   0.3078  
#> ZC            0.6023  3.3952     2.3099  1.4698     0.235   0.0644 .
#> X             0.6439  8.1773     3.6816  2.2211     0.331   0.1288  
#> ZB:X         -0.5979 -3.8933     2.5112 -1.5504    -0.238   0.3448  
...
#> Model 2: Y ~ Z * X
#>                    Df Score Pr(>Score)  
#> Model 2 vs Model 1  2 4.545      0.073 .
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
