...
#> ZC            0.9034 10.3392     3.4527  2.9945     0.348   0.0256 * 
...
#> Coefficients:
#>             Estimate   Score Std. Error z value Part. Cor Pr(>|z|)  
#> (Intercept)  -0.3549 -4.3865     3.8867 -1.1286    -0.189   0.0930 .
#> ZB            0.3570  2.3488     2.6093  0.9002     0.145   0.3176  
#> ZC            0.6023  3.3952     2.3099  1.4698     0.235   0.0614 .
#> X             0.6439  8.1773     3.6816  2.2211     0.331   0.1238  
#> ZB:X         -0.5979 -3.8933     2.5112 -1.5504    -0.238   0.3402  
...
#> Model 2: Y ~ Z * X
#>                    Df  Score Pr(>Score)  
#> Model 2 vs Model 1  2 4.5507     0.0696 .
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
