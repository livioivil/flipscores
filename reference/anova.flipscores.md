...
#> (Intercept)  -0.3513 -5.4234     4.2404 -1.2790    -0.169   0.1246  
#> ZB            0.2276  1.8048     2.8140  0.6414     0.079   0.4406  
#> ZC            0.9034 10.3392     3.4527  2.9945     0.348   0.0232 *
#> X             0.6381 33.1168     8.0470  4.1154     0.478   0.0132 *
#> ---
...
#> Coefficients:
#>             Estimate   Score Std. Error z value Part. Cor Pr(>|z|)  
#> (Intercept)  -0.3549 -4.3865     3.8867 -1.1286    -0.189   0.0900 .
#> ZB            0.3570  2.3488     2.6093  0.9002     0.145   0.3014  
#> ZC            0.6023  3.3952     2.3099  1.4698     0.235   0.0678 .
#> X             0.6439  8.1773     3.6816  2.2211     0.331   0.1284  
#> ZB:X         -0.5979 -3.8933     2.5112 -1.5504    -0.238   0.3494  
#> ZC:X          0.4856  2.8440     2.4290  1.1709     0.184   0.2238  
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> (Dispersion parameter for poisson family taken to be 1)
...
#> Model 2: Y ~ Z * X
#>                    Df  Score Pr(>Score)  
#> Model 2 vs Model 1  2 4.4919     0.0698 .
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
