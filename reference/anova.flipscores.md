...
#> (Intercept)  -0.3513 -5.4234     4.2404 -1.2790    -0.169   0.1178  
...
#> ZC            0.6023  3.3952     2.3099  1.4698     0.235   0.0740 .
#> X             0.6439  8.1773     3.6816  2.2211     0.331   0.1348  
#> ZB:X         -0.5979 -3.8933     2.5112 -1.5504    -0.238   0.3430  
#> ZC:X          0.4856  2.8440     2.4290  1.1709     0.184   0.2190  
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
#> 
#> (Dispersion parameter for poisson family taken to be 1)
...
#> Model 2: Y ~ Z * X
#>                    Df  Score Pr(>Score)  
#> Model 2 vs Model 1  2 4.5136     0.0688 .
#> ---
#> Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
```
