...
mod=flipscores::flipscores_glm(Survived~.+Class*Sex,data=Titanic,family = binomial, score_type = "ortho")
summary(mod)
```
...
mod=flipscores::flipscores_glm(Freq~.+Class*Sex, data=Titanic, family = poisson)
summary(mod)
```
...
mod=flipscores::flipscores_glm(Volume~Girth*Height, data=trees, family = gaussian)
summary(mod)
```
...
mod=flipscores::flipscores_glm(Freq~.+Class*Sex, data=Titanic, family = "negbinom")
summary(mod)
```
