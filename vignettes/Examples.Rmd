...
- statTest: C'� ANCORA?? Choose a test statistic from flip.statTest. See "flip" package.
- testType: C'� ANCORA?? by default testType="permutation". The use of option "combination" is more efficient when
...
mod=flipscores::flipscores_glm(Survived~.+Class*Sex, data=Titanic, family = poisson, score_type = "basic")
summary(mod)
```
...
data("motorins1")
mod=flipscores::flipscores_glm(Insured~., data=motorins1, family = Gamma, score_type = "basic")
summary(mod)
```
